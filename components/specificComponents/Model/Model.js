		...
		return (
			<div {...storyblokEditable(this.props.blok)}>
				...
				<main>
					...
					<div className={css["model-page__main-content"]}>
					<div id="model-page__short-description" key="model-page__short-description" className={css["model-page__short-description"]}>
