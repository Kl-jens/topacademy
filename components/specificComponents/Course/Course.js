			...
			<div {...storyblokEditable(this.props.blok)}>
				...
				<main>
					...
					<div className={css["course-page__main-content"]}>
						...
						<div id="course-page__short-description" key="course-page__short-description" className={css["course-page__short-description"]}>
							<section className={css["rich-text-section--with-navigator"]}>
								<h2 className={css["rich-text-section__title"]}>Destination</h2>
								{this.props.blok.destinations && this.props.blok.destinations.map((destination) => (
									<Element blok={destination} key={destination._uid} />
								))}
							</section>
						</div>
						<div id="course-page__short-description" key="course-page__short-description" className={css["course-page__short-description"]}>
						<section className={css["rich-text-section--with-navigator"]}>
								<h2 className={css["rich-text-section__title"]}>Pricing</h2>
								<div className={css["rich-text-section__rich-text"]}>{RichTextToHTML({ document: this.props.blok.pricing })}</div>
							</section>
						</div>
					</div>
